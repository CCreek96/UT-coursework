...
#  Description: Tutorial excercises assigned for the course C S 303E to be completed by 10 November 2017
...
#  Date Last Modified: 07 November 2017
...
def main(argv):
    ...
    count8_ans = [1, 2, 3, 3, 0, 2, 4, 1, 1, 2, 0, 4, 4, 1, 2, 5, 2, 1]
